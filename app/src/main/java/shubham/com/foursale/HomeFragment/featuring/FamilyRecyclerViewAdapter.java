...
import shubham.com.foursale.HomeFragment.ApiModel.Family;
...
public class FamilyRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ArrayList<Family> modelList;

    private OnItemClickListener mItemClickListener;


    public FamilyRecyclerViewAdapter(Context context, ArrayList<Family> modelList) {
        this.mContext = context;
        this.modelList = modelList;
    }

    public void updateList(ArrayList<Family> modelList) {
        this.modelList = modelList;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            final Family model = getItem(position);
    ...
    private Family getItem(int position) {
        return modelList.get(position);
    }


    public interface OnItemClickListener {
        void onItemClick(View view, int position, Family model);
    }
