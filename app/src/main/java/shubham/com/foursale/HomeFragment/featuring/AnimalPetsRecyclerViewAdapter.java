...
import shubham.com.foursale.HomeFragment.ApiModel.Annimals$Pet;
 ...
 */
public class AnimalPetsRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private ArrayList<Annimals$Pet> modelList;

    private OnItemClickListener mItemClickListener;


    public AnimalPetsRecyclerViewAdapter(Context context, ArrayList<Annimals$Pet> modelList) {
        this.mContext = context;
        this.modelList = modelList;
    }

    public void updateList(ArrayList<Annimals$Pet> modelList) {
        this.modelList = modelList;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            final Annimals$Pet model = getItem(position);
    ...
    private Annimals$Pet getItem(int position) {
        return modelList.get(position);
    }


    public interface OnItemClickListener {
        void onItemClick(View view, int position, Annimals$Pet model);
    }
