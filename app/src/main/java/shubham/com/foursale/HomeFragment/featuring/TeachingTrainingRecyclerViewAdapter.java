...
import shubham.com.foursale.HomeFragment.ApiModel.TeachingTraning;
 ...
 */
public class TeachingTrainingRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private ArrayList<TeachingTraning> modelList;

    private OnItemClickListener mItemClickListener;


    public TeachingTrainingRecyclerViewAdapter(Context context, ArrayList<TeachingTraning> modelList) {
        this.mContext = context;
        this.modelList = modelList;
    }

    public void updateList(ArrayList<TeachingTraning> modelList) {
        this.modelList = modelList;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            final TeachingTraning model = getItem(position);
    ...
    private TeachingTraning getItem(int position) {
        return modelList.get(position);
    }


    public interface OnItemClickListener {
        void onItemClick(View view, int position, TeachingTraning model);
    }
