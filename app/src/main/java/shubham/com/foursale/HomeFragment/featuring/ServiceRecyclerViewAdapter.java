...
public class ServiceRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ArrayList<Service> modelList;

    private OnItemClickListener mItemClickListener;


    public ServiceRecyclerViewAdapter(Context context, ArrayList<Service> modelList) {
        this.mContext = context;
        this.modelList = modelList;
    }

    public void updateList(ArrayList<Service> modelList) {
        this.modelList = modelList;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            final Service model = getItem(position);
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, int position, Service model);
    }
