 ...
 */
public class AddRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AddRecyclerViewAdapter(Context context, ArrayList<Featured> modelList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_recycler_list_add, viewGroup, false);
