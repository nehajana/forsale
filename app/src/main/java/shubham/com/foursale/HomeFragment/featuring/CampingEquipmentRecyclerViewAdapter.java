...
import shubham.com.foursale.HomeFragment.ApiModel.CampingEquipment;
 ...
 */
public class CampingEquipmentRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private ArrayList<CampingEquipment> modelList;

    private OnItemClickListener mItemClickListener;


    public CampingEquipmentRecyclerViewAdapter(Context context, ArrayList<CampingEquipment> modelList) {
        this.mContext = context;
        this.modelList = modelList;
    }

    public void updateList(ArrayList<CampingEquipment> modelList) {
        this.modelList = modelList;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            final CampingEquipment model = getItem(position);
    ...
    private CampingEquipment getItem(int position) {
        return modelList.get(position);
    }


    public interface OnItemClickListener {
        void onItemClick(View view, int position, CampingEquipment model);
    }
