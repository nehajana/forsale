...
import shubham.com.foursale.HomeFragment.ApiModel.YourHealth;
 ...
 */
public class YourHealthRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private ArrayList<YourHealth> modelList;

    private OnItemClickListener mItemClickListener;


    public YourHealthRecyclerViewAdapter(Context context, ArrayList<YourHealth> modelList) {
        this.mContext = context;
        this.modelList = modelList;
    }

    public void updateList(ArrayList<YourHealth> modelList) {
        this.modelList = modelList;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            final YourHealth model = getItem(position);
    ...
    private YourHealth getItem(int position) {
        return modelList.get(position);
    }


    public interface OnItemClickListener {
        void onItemClick(View view, int position, YourHealth model);
    }
