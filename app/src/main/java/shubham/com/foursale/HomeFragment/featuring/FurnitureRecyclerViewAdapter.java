...
import shubham.com.foursale.HomeFragment.ApiModel.Furniture;
 ...
 */
public class FurnitureRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private ArrayList<Furniture> modelList;

    private OnItemClickListener mItemClickListener;


    public FurnitureRecyclerViewAdapter(Context context, ArrayList<Furniture> modelList) {
        this.mContext = context;
        this.modelList = modelList;
    }

    public void updateList(ArrayList<Furniture> modelList) {
        this.modelList = modelList;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            final Furniture model = getItem(position);
    ...
    private Furniture getItem(int position) {
        return modelList.get(position);
    }


    public interface OnItemClickListener {
        void onItemClick(View view, int position, Furniture model);
    }
