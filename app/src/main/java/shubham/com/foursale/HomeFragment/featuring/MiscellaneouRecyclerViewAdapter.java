...
import shubham.com.foursale.HomeFragment.ApiModel.Miscellaneou;
 ...
 */
public class MiscellaneouRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private ArrayList<Miscellaneou> modelList;

    private OnItemClickListener mItemClickListener;


    public MiscellaneouRecyclerViewAdapter(Context context, ArrayList<Miscellaneou> modelList) {
        this.mContext = context;
        this.modelList = modelList;
    }

    public void updateList(ArrayList<Miscellaneou> modelList) {
        this.modelList = modelList;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            final Miscellaneou model = getItem(position);
    ...
    private Miscellaneou getItem(int position) {
        return modelList.get(position);
    }


    public interface OnItemClickListener {
        void onItemClick(View view, int position, Miscellaneou model);
    }
