...
import shubham.com.foursale.HomeFragment.ApiModel.Food;
...
public class FoodRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ArrayList<Food> modelList;

    private OnItemClickListener mItemClickListener;


    public FoodRecyclerViewAdapter(Context context, ArrayList<Food> modelList) {
        this.mContext = context;
        this.modelList = modelList;
    }

    public void updateList(ArrayList<Food> modelList) {
        this.modelList = modelList;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            final Food model = getItem(position);
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, int position, Food model);
    }
